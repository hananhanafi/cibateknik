        ...
        <b-container>
            ...
            <div class="bg-white shadow rounded-8 p-3 text-left ">
                ...
                <div class="form-group">
                    <div class="mb-3">
                        <h6>Nama Barang</h6>
                        <b-form-input v-model="barang.nama" class="rounded-pill mb-2" placeholder="Masukkan nama barang"></b-form-input>
                    </div>
                    <div class="mb-3">
                        ...
                        <b-row>
                            <b-col>
                                ...
                                <b-row v-for="(info,i) in infoCount" :key="i">
                                    <b-col>
                                        <b-form-input v-model="barang.addInfo.title"   class="rounded-pill mb-2" placeholder="Masukkan nama informasi"></b-form-input>
                                    </b-col>
                                    <b-col>
                                        <b-form-input v-model="barang.addInfo.value" class="rounded-pill mb-2" placeholder="Masukkan keterangan informasi barang"></b-form-input>
                                    </b-col>
                                </b-row>
                            </b-col>
                            <b-col md="1">
                                <b-button id="show-btn"  size="xl"  class="rounded-pill text-white w-100" variant="primary" @click="addInfo()">+</b-button>
                            </b-col>
                            <b-col md="1">
                                <b-button id="show-btn"  size="xl"  class="rounded-pill text-white w-100" variant="danger" @click="minInfo()">-</b-button>
                            </b-col>
                        </b-row>
                    </div>
                    <div class="mb-3">
                        <h6>Stock Barang</h6>
                        <b-form-input v-model="barang.stock" class="rounded-pill mb-2" placeholder="Masukkan stock barang"></b-form-input>
                    </div>
                    <div class="mb-3">
                        <h6>Minimum Stock</h6>
                        <b-form-input v-model="barang.minimumStock" class="rounded-pill mb-2" placeholder="Masukkan minimum stock barang"></b-form-input>
                    </div>
                    <div class="mb-3">
                        <h6>Harga</h6>
                        <b-form-input v-model="barang.harga" class="rounded-pill mb-2" placeholder="Masukkan harga barang"></b-form-input>
                    </div>
                    <div class="mb-3">
                        <h6>Foto Barang</h6>
                    ...
                    <div class="w-100">
                        <div class="text-right">
                            <b-button id="show-btn"  size="xl"  class="rounded-pill ml-auto" variant="outline-dark">Batal</b-button>
                            <b-button id="show-btn"  size="xl"  class="rounded-pill text-white ml-auto" variant="success">Simpan</b-button>
                        </div>
                    </div>
                </div>
            </div>
