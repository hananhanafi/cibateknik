    ...
    <Modal :show="show" large centered @clickOutside="clickOutside">
        <div class="bg-white shadow-sm rounded-8 p-3 text-left">
            <div v-if="isSubmitStatus=='' || isSubmitStatus == submitStatus.pending">
                <div v-if="isSubmitStatus=='' || isSubmitStatus == submitStatus.pending" class="modal-body">
                    ...
                    <div class="form-check mr-2 form-control-sm">
                        <input id="check-all-add-recommendation-item" v-model="checkAll" class="form-check-input" type="checkbox" value="all" @change="checkAllHandler()">
                        <label class="form-check-label" for="check-all-add-recommendation-item">
                            semua
                        </label>
                    </div>
                    ...
                    <div v-if="items.length>0" class="row px-2">
                        ...
                        <div class="col-12 d-flex">
                            <div class="ml-auto">
                                <button v-show="!isLastPage" :disabled="isLoadingData" class="btn btn-outline-primary border w-100" @click.prevent="loadMore">Muat Lagi</button>
                            </div>
                        </div>
                    </div>
            ...
            <div v-show="isSubmitStatus==submitStatus.success" class="px-2 text-center">
                ...
                <div class="text-20">
                    Berhasil menambahkan data barang pada katalog barang rekomendasi.
                </div>
            ...
            <div v-show="isSubmitStatus==submitStatus.error" class="px-2 text-center">
                ...
                <div class="text-20">
                    Gagal menambahkan data barang pada katalog barang rekomendasi.
                </div>
...
export default {
    ...
    computed: {
        ...
        methods: {
            ...
            await ApiService.post(`/item-posted-recommendation`,{items_id:this.checkedItemList})
            .then(()=>{
