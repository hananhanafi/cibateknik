                        ...
                        <div>
                            ...
                            >
                                <div class="p-5 text-medium">
                                    <h2 >Daftar</h2>
                                    <b-button style="height:60px"  class="w-100 bg-main-color" @click="postLogin">Daftar</b-button>
                                    
                                    <h4 class="my-3 text-center">
                                        Atau
                                    </h4>
                                    
                                    <b-button  class="w-100 bg-white text-dark border-0 shadow-main p-2 mb-3 " @click="postLogin">
                                        <b-img class="mr-3" src="~/assets/img/media-social/google.png" fluid alt="Responsive image"></b-img> Masuk Dengan Google
                                    </b-button>
                                    <b-button  class="w-100 text-white border-0  p-2 " style="background-color:#4267B2" @click="postLogin">
