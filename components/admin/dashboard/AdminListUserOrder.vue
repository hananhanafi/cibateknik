    ...
    <div class="row mb-3">
                            ...
                            <tr v-for="(order,i) in usersOrder" :key="i" :class="{ 'bg-light':order.statusOrder==='DONE' }"  >
                                ...
                                <td class="text-center">
                                    ...
                                    <button v-if=" order && order.statusOrder=='PACKING' && order.invoice.status == 'PAID'" class="btn btn-warning btn-sm" @click="showModalEditStatusOrder(order)" >
                                        <fa :icon="['fas','shipping-fast']"/> Kirim Barang
                                    </button>
                                    <button v-if=" order && order.statusOrder=='SHIPPING' && order.invoice.status == 'PAID'" class="btn btn-success btn-sm" @click="showModalEditStatusOrder(order)" >
                                        <fa :icon="['fas','check']"/> Selesaikan Pesanan
                                    </button>
                                </td>
                            </tr>
                        </tbody>
        ...
        <div class="col-md-5 col-lg-3 col-12">
            <div class="bg-white shadow-sm rounded-8 p-3 ">
                ...
                <div style="height:100px" class="w-100 shadow-sm text-white rounded-8 p-3 mb-4 shadow bg-success">
                    <div class="row h-100 align-items-center">
                        <div  class="col-md-6 col-12 text-left">
                            <div class="font-weight-bold text-16">
                        ...
                        <div class="col">
                            <div style="font-size:2rem">
                                {{ usersOrderTotal && usersOrderTotal.done ||'-' }}
                            </div>
                        </div>
                    </div>
                </div>
                <div style="height:100px" class="w-100 shadow-sm text-white rounded-8 p-3 mb-4 shadow bg-info">
                    <div class="row h-100 align-items-center">
                        <div  class="col-md-6 col-12 text-left">
                            <div class="font-weight-bold text-16">
                        ...
                        <div class="col">
                            <div style="font-size:2rem">
                                {{ usersOrderTotal && usersOrderTotal.shipping ||'-' }}
                            </div>
                        </div>
                    </div>
                </div>
                <div style="height:100px" class="w-100 shadow-sm text-white rounded-8 p-3 mb-4 shadow bg-primary">
                    <div class="row h-100 align-items-center">
                        <div  class="col-md-6 col-12 text-left">
                            <div class="font-weight-bold text-16">
                        ...
                        <div class="col">
                            <div style="font-size:2rem">
                                {{ usersOrderTotal && usersOrderTotal.packing ||'-' }}
                            </div>
                        </div>
                    </div>
                </div>
                <div style="height:100px" class="w-100 shadow-sm text-white rounded-8 p-3 mb-4 shadow bg-warning">
                    <div class="row h-100 align-items-center">
                        <div  class="col-md-6 col-12 text-left">
                            <div class="font-weight-bold text-16">
                        ...
                        <div class="col">
                            <div style="font-size:2rem">
                                {{ usersOrderTotal && usersOrderTotal.pending ||'-' }}
                            </div>
                        </div>
                    </div>
                </div>
                <div style="height:100px" class="w-100 shadow-sm text-white rounded-8 p-3 mb-4 shadow bg-danger">
                    <div class="row h-100 align-items-center">
                        <div  class="col-md-6 col-12 text-left">
                            <div class="font-weight-bold text-16">
                        ...
                        <div class="col">
                            <div style="font-size:2rem">
                                {{ usersOrderTotal && usersOrderTotal.expired ||'-' }}
                            </div>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        updateStatusOrderHandler(value) {
            ...
            if(updatedOrder.statusOrder==='DONE'){
                this.usersOrderTotal.done++;
                this.usersOrderTotal.shipping--;
            }else if(updatedOrder.statusOrder==='SHIPPING'){
                this.usersOrderTotal.shipping++;
                this.usersOrderTotal.packing++;
            }  
        },
        ...
        async loadData() {
            ...
            .then((Response)=>{
                ...
                this.usersOrderTotal = Response.data.total;
            })
            .catch(err=>{
                console.log("err",err);
            })
